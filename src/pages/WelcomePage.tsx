      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-3xl shadow-lg px-8 py-8">
          ...
          <div className="flex items-center gap-3 my-4">
            <div className="flex-1 h-px" style={{ background: "rgba(232,134,58,0.2)" }} />
            <span className="text-xs" style={{ color: "rgba(45,24,16,0.4)" }}>oder</span>
            <div className="flex-1 h-px" style={{ background: "rgba(232,134,58,0.2)" }} />
          </div>
          ...
          <Button
            ...
            className="w-full h-12 rounded-2xl text-sm font-semibold border-2 flex items-center justify-center gap-3"
            style={{ borderColor: "rgba(232,134,58,0.3)", color: "rgba(45,24,16,0.8)" }}
          >
            {isGoogleLoading ? (
